...
@Component({
  selector: 'app-notas-menores-intro',
  templateUrl: './notas-menores-intro.component.html',
  styleUrls: ['./notas-menores-intro.component.css']
})
export class NotasMenoresIntroComponent {
