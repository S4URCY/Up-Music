...
@Component({
  selector: 'app-extras4',
  templateUrl: './extras4.component.html',
  styleUrls: ['./extras4.component.css']
})
export class Extras4Component  {
  ...
  resultado() {
  if (this.qtd_erros == 0){
      this.extras4 = this.extras4 + 3
  }
  if (this.qtd_erros <= 3 && this.qtd_erros > 0){
    this.extras4 = this.extras4 + 2
  }
  if (this.qtd_erros > 3){
    this.extras4 = this.extras4 + 1
  }
    this.tela = 'resultado';
    console.log('QTD_ESTRELAS',this.extras4);
    }
