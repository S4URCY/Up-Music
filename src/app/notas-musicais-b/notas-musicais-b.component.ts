...
@Component({
  selector: 'app-notas-musicais-b',
  templateUrl: './notas-musicais-b.component.html',
  styleUrls: ['./notas-musicais-b.component.css'],
  encapsulation: ViewEncapsulation.None
})
export class NotasMusicaisBComponent {
  ...
  resultado() {
  if (this.qtd_erros == 0){
      this.estrelasB = this.estrelasB + 3
  }
  if (this.qtd_erros <= 3 && this.qtd_erros > 0){
    this.estrelasB = this.estrelasB + 2
  }
  if (this.qtd_erros > 3){
    this.estrelasB = this.estrelasB + 1
  }
    this.tela = 'resultado';
    console.log('QTD_ESTRELAS',this.estrelasB);
    }
