...
@Component({
  selector: 'app-notas-sustenidas-intro',
  templateUrl: './notas-sustenidas-intro.component.html',
  styleUrls: ['./notas-sustenidas-intro.component.css']
})
export class NotasSustenidasIntroComponent  {

  tela = 'exe1';
  qtd_acertos = 0;
  qtd_erros = 0;
  estrelasSustenidasIntro = 0;
