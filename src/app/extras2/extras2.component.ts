...
@Component({
  selector: 'app-extras2',
  templateUrl: './extras2.component.html',
  styleUrls: ['./extras2.component.css']
})
export class Extras2Component  {
  ...
  resultado() {
  if (this.qtd_erros == 0){
      this.extras2 = this.extras2 + 3
  }
  if (this.qtd_erros <= 3 && this.qtd_erros > 0){
    this.extras2 = this.extras2 + 2
  }
  if (this.qtd_erros > 3){
    this.extras2 = this.extras2 + 1
  }
    this.tela = 'resultado';
    console.log('QTD_ESTRELAS',this.extras2);
    }
