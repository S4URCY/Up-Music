...
@Component({
  selector: 'app-extras3',
  templateUrl: './extras3.component.html',
  styleUrls: ['./extras3.component.css']
})
export class Extras3Component {
  ...
  resultado() {
  if (this.qtd_erros == 0){
      this.extras3 = this.extras3 + 3
  }
  if (this.qtd_erros <= 3 && this.qtd_erros > 0){
    this.extras3 = this.extras3 + 2
  }
  if (this.qtd_erros > 3){
    this.extras3 = this.extras3 + 1
  }
    this.tela = 'resultado';
    console.log('QTD_ESTRELAS',this.extras3);
    }
